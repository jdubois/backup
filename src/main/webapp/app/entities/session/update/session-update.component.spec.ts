...
describe('Session Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Speaker query and add missing value', () => {
      ...
      const speaker: ISpeaker = { id: 29206 };
      session.speaker = speaker;

      const speakerCollection: ISpeaker[] = [{ id: 1546 }];
    ...
    it('Should call Conference query and add missing value', () => {
      const session: ISession = { id: 456 };
      const conference: IConference = { id: 22370 };
      session.conference = conference;

      const conferenceCollection: IConference[] = [{ id: 18067 }];
    ...
    it('Should call Attendee query and add missing value', () => {
      const session: ISession = { id: 456 };
      const attendees: IAttendee[] = [{ id: 29010 }];
      session.attendees = attendees;

      const attendeeCollection: IAttendee[] = [{ id: 9620 }];
    ...
    it('Should update editForm', () => {
      const session: ISession = { id: 456 };
      const speaker: ISpeaker = { id: 11818 };
      session.speaker = speaker;
      const conference: IConference = { id: 2390 };
      session.conference = conference;
      const attendee: IAttendee = { id: 2748 };
