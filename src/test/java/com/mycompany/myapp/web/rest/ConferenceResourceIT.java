...
class ConferenceResourceIT {
    ...
    public static Conference createEntity(EntityManager em) {
        Conference conference = new Conference().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).date(DEFAULT_DATE);
        return conference;
    }
    ...
    public static Conference createUpdatedEntity(EntityManager em) {
        Conference conference = new Conference().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
        return conference;
    }
    ...
    void putExistingConference() throws Exception {
        ...
        updatedConference.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
    ...
    void partialUpdateConferenceWithPatch() throws Exception {
        ...
        partialUpdatedConference.title(UPDATED_TITLE).date(UPDATED_DATE);
    ...
    void fullUpdateConferenceWithPatch() throws Exception {
        ...
        partialUpdatedConference.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
